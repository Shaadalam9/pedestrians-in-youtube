...
# Plotting functions:
    ...
    def correlation_matrix(df_mapping):
        ...
        (ped_cross_city, ped_crossing_count, person_city, bicycle_city, car_city,
         ...
         cellphone_city, trf_sign_city, speed_values, time_values, avg_time, avg_speed) = data_tuple[1:]
...
if __name__ == "__main__":
    ...
    if os.path.exists(pickle_file_path):
        ...
        with open(pickle_file_path, 'rb') as file:
            (data, pedestrian_cross_city, pedestrian_crossing_count, person_city, bicycle_city, car_city,
             motorcycle_city, bus_city, truck_city, cross_evnt_city, vehicle_city,
        ...
        with open(pickle_file_path, 'wb') as file:
            pickle.dump((data, pedestrian_cross_city, pedestrian_crossing_count, person_city, bicycle_city, car_city,
                         motorcycle_city, bus_city, truck_city, cross_evnt_city, vehicle_city,
